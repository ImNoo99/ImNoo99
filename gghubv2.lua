if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    Toggle.BackgroundColor3 = Color3.fromRGB(210, 105, 30)
    Toggle.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
    Toggle.Size = UDim2.new(0, 50, 0, 50)
    Toggle.Font = Enum.Font.Code
    Toggle.Text = "close/open"
    Toggle.TextColor3 = Color3.fromRGB( 0, 128, 0)
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("Vin | Hub",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
...
local RigC2 = getupvalues(RigC)[2] 
...
spawn(function()
    game:GetService('RunService').Heartbeat:connect(function()
        if _G.FastAttack then
            pcall(function()              
                RigC2.activeController.attacking = false
                RigC2.activeController.blocking = false
                RigC2.activeController.timeToNextBlock = 0
                RigC2.activeController.increment = 3
                RigC2.activeController.hitboxMagnitude = 70
                RigC2.activeController.humanoid.AutoRotate = true
                RigC2.activeController.focusStart = 0
...
Misc:AddToggle("FastAttack",true, function(value)
    _G.FastAttack = value
end)
